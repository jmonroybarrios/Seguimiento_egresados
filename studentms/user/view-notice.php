...
<html lang="en">
  <head>
    ...
    <title>Sistema de Seguimiento de Egresados|| Ver aviso</title>
    <!-- plugins:css -->
        ...
        <div class="main-panel">
          <div class="content-wrapper">
            <div class="page-header">
              <h3 class="page-title"> Ver aviso </h3>
              <nav aria-label="breadcrumb">
                <ol class="breadcrumb">
                  <li class="breadcrumb-item"><a href="dashboard.php">Dashboard</a></li>
                  <li class="breadcrumb-item active" aria-current="page"> Ver aviso</li>
                </ol>
              </nav>
            </div>
            <div class="row">
...
<tr class="table-info">
  ...
  <?php $cnt=$cnt+1;}} else { ?>
<tr>
  <th colspan="2" style="color:red;">No se encontró ningún aviso</th>
</tr>
  <?php } ?>
</table>
                  </div>
