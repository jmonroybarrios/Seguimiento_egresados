...
<html lang="en">
  <head>
    ...
    <title>Sistema de SEguimiento de Egresados|| Actualizar estudiantes</title>
    <!-- plugins:css -->
...
<option value="<?php echo htmlentities($row1->ClassName);?><?php echo htmlentities($row1->Section);?>"><?php echo htmlentities($row1->ClassName);?> <?php echo htmlentities($row1->Section);?></option>
 <?php } ?> 
                      ...
                      <h3>Actitudes laborales</h3>
                      <div class="form-group">
                        <label for="exampleInputName1">Conocimientos en la especialidad</label>
                      ...
                      <div class="form-group">
                        <label for="exampleInputName1">Conocimientos en la especialidad</label>
                        <input type="text" name="connum" value="<?php  echo htmlentities($row->ContactNumber);?>" class="form-control" required='true' maxlength="255">
                      </div>
                      <div class="form-group">
                        <label for="exampleInputName1">Conocimientos en la especialidad</label>
                        <input type="text" name="altconnum" value="<?php  echo htmlentities($row->AltenateNumber);?>" class="form-control" required='true' maxlength="255">
                      </div>
                      <div class="form-group">
                        <label for="exampleInputName1">Conocimientos en la especialidad</label>
