...
<html lang="en">
  <head>
    ...
    <title>Sistema de Seguimiento de Egesados|| Estudiante Cambiar Contraseña</title>
    <!-- plugins:css -->
        ...
        <div class="main-panel">
          <div class="content-wrapper">
            <div class="page-header">
              <h3 class="page-title"> Cambiar la contraseña </h3>
            ...
            <div class="row">
              ...
              <div class="col-12 grid-margin stretch-card">
                <div class="card">
                  <div class="card-body">
                    <h4 class="card-title" style="text-align: center;">Cambiar la contraseña</h4>
