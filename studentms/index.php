...
<html>
<head>
<title>Sistema de Seguimiento de Egresados || Página de inicio</title>
...
<div class="slider">
       <div class="callbacks_container">
        <ul class="rslides" id="slider">
         <li>     
          <h3>Sistema de seguimiento de egresados</h3>      
           <p>Los egresados registrados pueden iniciar sesión aquí</p>             
          <div class="readmore">
          <a href="user/login.php">Inicio de sesión<i class="glyphicon glyphicon-menu-right"> </i></a>
          </div>
         </li>
