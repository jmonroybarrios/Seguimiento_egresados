...
$query->bindParam(':section',$section,PDO::PARAM_STR);
 $query->execute();
   ...
   if ($LastInsertId>0) {
    echo '<script>alert("se ha agregado la carrera.")</script>';
...
<html lang="en">
  <head>
    ...
    <title>Sistema de Seguimiento de Egresados|| Agregar carrera</title>
    <!-- plugins:css -->
        ...
        <div class="main-panel">
          <div class="content-wrapper">
            <div class="page-header">
              <h3 class="page-title"> Agregar carrera </h3>
            ...
            <div class="row">
              ...
              <div class="col-12 grid-margin stretch-card">
                <div class="card">
                  <div class="card-body">
                    <h4 class="card-title" style="text-align: center;">Agregar Especialidad</h4>
                    ...
                    <form class="forms-sample" method="post">
                      ...
                      <div class="form-group">
                        <label for="exampleInputEmail3">Especialidad</label>
