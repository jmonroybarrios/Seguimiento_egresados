...
<html lang="en">
  <head>
    ...
    <title>Sistema de Seguimiento de Egresados|| Agregar estudiantes</title>
    <!-- plugins:css -->
        ...
        <div class="main-panel">
          <div class="content-wrapper">
            <div class="page-header">
              <h3 class="page-title"> Agregar estudiantes</h3>
            ...
            <div class="row">
              ...
              <div class="col-12 grid-margin stretch-card">
                <div class="card">
                  <div class="card-body">
                    <h4 class="card-title" style="text-align: center;">Agregar estudiantes</h4>
                   
                    <form class="forms-sample" method="post" enctype="multipart/form-data">
                      
                      <div class="form-group">
                        <label for="exampleInputName1">Nombre del Egresado</label>
                      ...
                      <div class="form-group">
                        <label for="exampleInputEmail3">Clase de estudiante</label>
...
<option value="<?php echo htmlentities($row1->ID);?>"><?php echo htmlentities($row1->ClassName);?> <?php echo htmlentities($row1->Section);?></option>
 <?php } ?> 
                      ...
                      <div class="form-group">
                        <label for="exampleInputName1">ID Egresado</label>
                      ...
                      <h3>Detalles de los padres / tutores</h3>
                      <div class="form-group">
