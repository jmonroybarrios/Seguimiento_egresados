...
<html lang="en">
  <head>
    ...
    <title>Sistema de Seguimineto de Egresados|| Administrar clase</title>
    <!-- plugins:css -->
          ...
          <div class="content-wrapper">
            ...
            <div class="row">
              ...
              <div class="col-12 grid-margin stretch-card">
                <div class="card">
                  <div class="card-body">
                    <h4 class="card-title" style="text-align: center;">Administrar clase</h4>
...
{               ?>  
                      <div class="form-group">
                        <label for="exampleInputName1">Nombre de clase</label>
