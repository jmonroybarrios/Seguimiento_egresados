                ...
                <div class="card">
                  <div class="card-body">
                    <div class="d-sm-flex align-items-center mb-4">
                      <h4 class="card-title mb-sm-0">Administrar aviso público</h4>
                      <a href="#" class="text-dark ml-auto mb-3 mb-sm-0"> Ver todo Aviso público</a>
                    </div>
                      ...
                      <table class="table">
                        <thead>
                          <tr>
                            ...
                            <th class="font-weight-bold">Fecha de notificacion</th>
