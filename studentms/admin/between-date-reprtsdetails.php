...
<html lang="en">
  <head>
    ...
    <title>Sistema de Seguimineto de Egresados|||Entre Fechas Informes</title>
    <!-- plugins:css -->
...
?>
<h5 align="center" style="color:blue">Informe de <?php echo $fdate?> Hasta<?php echo $tdate?></h5>
                    </div>
