...
<html lang="en">
  <head>
    ...
    <title>Sistema de Seguimiento de Egresado|| Has olvidado tu contraseña</title>
    <!-- plugins:css -->
          ...
          <div class="row flex-grow">
            <div class="col-lg-4 mx-auto">
              <div class="auth-form-light text-left p-5">
                ...
                <h6 class="font-weight-light">¡Ingrese su dirección de correo electrónico y número de teléfono móvil para restablecer la contraseña!</h6>
                <form class="pt-3" id="login" method="post" name="login">
                  ...
                  <div class="mt-3">
                    <button class="btn btn-success btn-block loginbtn" name="submit" type="submit">Reiniciar</button>
                  </div>
                  ...
                  <div class="mb-2">
                    <a href="../index.php" class="btn btn-block btn-facebook auth-form-btn">
                      <i class="icon-social-home mr-2"></i>volver al Inicio </a>
                  </div>
