...
<html lang="en">
  <head>
    ...
    <title>Sistema de Seguimiento de Egresados|| Actualizar Contáctenos</title>
    <!-- plugins:css -->
        ...
        <div class="main-panel">
          <div class="content-wrapper">
            <div class="page-header">
              <h3 class="page-title"> Actualizar Contáctenos </h3>
              <nav aria-label="breadcrumb">
                <ol class="breadcrumb">
                  <li class="breadcrumb-item"><a href="dashboard.php">Dashboard</a></li>
                  <li class="breadcrumb-item active" aria-current="page">Actualizar Contáctenos</li>
                </ol>
              </nav>
            </div>
            <div class="row">
              ...
              <div class="col-12 grid-margin stretch-card">
                <div class="card">
                  <div class="card-body">
                    <h4 class="card-title" style="text-align: center;">Actualizar Contáctenos</h4>
...
{               ?>    
                      <div class="form-group">
                        <label for="exampleInputName1">Título de la página:</label>
                        <input type="text" name="pagetitle" value="<?php  echo $row->PageTitle;?>" class="form-control" required='true'>
                      </div>
                      <div class="form-group">
                        <label for="exampleInputName1">Descripcion de la Página</label>
                      ...
                      <div class="form-group">
                        <label for="exampleInputName1">Número de teléfono móvil:</label>
